...
public class KoPostVO {
	...
	public String getPath_post_contnet() {
		return path_post_contnet;
	}

	public void setPath_post_contnet(String path_post_contnet) {
		this.path_post_contnet = path_post_contnet;
	}
