		...
		<div class="swipe-Wrapper">
		 ...
		 <div id = "hot-place-wrapper">
		 	...
		 	<div id = thema-wrapper>
			 	<div class= "thema-box">
			 		<div id="tourist" > <span class="areaName">{지역}</span> 추천 관광지</div>
			 		<div id="touristPlace" class="place-Wrapper"> 
			 		</div>
			 	</div>
			 	<div class= "thema-box">
			 		<div id="party"><span class="areaName">{지역}</span> 추천 축제</div>
			 		<div id="partyPlace"  class="place-Wrapper "></div>
			 	</div>
			 	
			 	<div class= "thema-box">
			 		<div id="restaurant"><span class="areaName">{지역}</span> 추천 맛집</div>
